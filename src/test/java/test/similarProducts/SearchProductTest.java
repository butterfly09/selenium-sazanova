...
public class SearchProductTest extends BaseTest{
    ...
    public void searchSimilarProducts(String product1, String product2){
        ...
        Assert.assertEquals( products.get(FIRST_ELEMENT), product1, Log4Test.info("Первый продукт правильно добавлен к сравнению.") );
        Assert.assertEquals( products.get(SECOND_ELEMENT), product2, Log4Test.info("Второй продукт правильно добавлен к сравнению.") );
    }
}
